...
namespace fap_crawler
{
    public partial class Form1 : Form
    {
        ...
        private async void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (isLogin)
            {
                //textArea.AppendText("Login Successfully\n");
        ...
        //    try
        //    {
        //        FileInfo file = new FileInfo(config?.LogPath);
        //        if(!file.Exists)
        //        {
        //            using (StreamWriter sw = file.CreateText())
        //            {
        //                foreach (string s in brwTle)
        //                {
        //                    sw.WriteLine(s);
        //                }
        //            }
        ...
        //        try
        //        {
        //            // Code for Get Google History
        //            brwTle = new List<string>();

        //            SQLiteConnection conn = new SQLiteConnection(config?.HistoryPath);
        //            conn.Open();
        ...
        //            while (reader.Read())
        //            {
        //                brwTle.Add(reader.GetString(1) + "\n");
        //            }
        //        }
        //        catch (Exception ex2)
        //        {
        //            textArea.AppendText("Warning2...\n");
        //        }
        //    }
        //    catch (Exception ex1)
        //    {
        //        textArea.AppendText("Warning1...\n");
        //    }


        //}

        //private async Task testcrawlDataForEachStudent(string studentCode, WorkSheet destSheet)
        //{
        //    progress = 0;
        //    total = 10000 * majorPrefixs.Count * prefixs.Count;

        //    string link = seedLinkStaticPart;

        //    try
        //    {
        //        await page.GoToAsync(link + "/" + studentCode);
        ...
        //                let data = {subjectCode: objCells.item(3).innerText, averageMark: objCells.item(8).innerText}; 
        //                grades.push(data);
        //            }
        //            return grades;
        //        }";
        ...
        private async Task CrawlDataForEachWorkSheet(string majorPrefix)
        {
            ...
            foreach (string k in prefixs)
            {
                ...
                //{
                //    await testcrawlDataForEachStudent(majorPrefix + k + i.ToString("D4"), workSheet);
                //    i += 199;
                //}
            }
        }
